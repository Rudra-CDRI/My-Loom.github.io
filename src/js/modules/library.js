              ...
              <div class="card">
                ...
                <div class="card-header">
                  ...
                  <div class="card-actions">
                    <button class="btn btn-icon btn-copy" data-url="${escapeHTML(b.url)}" style="padding: 0.35rem; display: flex; align-items: center; justify-content: center;" title="Copy Link">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>
                    </button>
                    <button class="btn btn-icon btn-edit-bookmark" data-id="${b.id}" style="padding: 0.35rem; display: flex; align-items: center; justify-content: center;" title="Modify Link">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                    </button>
                    <button class="btn btn-icon btn-delete-bookmark" data-id="${b.id}" style="padding: 0.35rem; display: flex; align-items: center; justify-content: center; color: var(--danger);" title="Purge Link">
