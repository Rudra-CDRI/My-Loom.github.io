  ...
  return `
    <tr class="${isCompletedDrawer ? 'completed-task-row' : ''}" style="${isCompletedDrawer ? 'display: none; ' : ''}${isDone ? 'opacity: 0.5;' : ''}">
      ...
      <td style="text-align: right; vertical-align: middle;">
        <div class="row-actions" style="display: flex; justify-content: flex-end; align-items: center; gap: 4px;">
          <button class="btn btn-icon btn-cycle" data-id="${task.id}" style="padding: 0.35rem; display: flex; align-items: center; justify-content: center;" title="Cycle status">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"></polyline><polyline points="1 20 1 14 7 14"></polyline><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"></path></svg>
          </button>
          <button class="btn btn-icon btn-edit" data-id="${task.id}" style="padding: 0.35rem; display: flex; align-items: center; justify-content: center;" title="Modify Task">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
          </button>
          <button class="btn btn-icon btn-delete" data-id="${task.id}" style="padding: 0.35rem; display: flex; align-items: center; justify-content: center; color: var(--danger);" title="Purge Task">
